...
export const Banner = () => {
  return (
    <div className="max-h-lvh bg-bgdark">
      <div
        className="flex h-full w-full bg-cover bg-no-repeat bg-center py-16"
        style={{ backgroundImage: `url(${bannerIMG})` }}
      >
        <div className="flex xl:h-2/3 lg:h-1/2 md:h-1/3 h-48 md:w-8/12 w-10/12 mx-auto flex-col items-center justify-center relative text-center">
          {" "}
          {/* Changed here */}
          ...
          <Link
            to="/allinventory"
            className="btn bg-primary  px-4 py-2 rounded-3xl text-secondary font-secondary font-extralight"
          >
            All Inventory
          </Link>
